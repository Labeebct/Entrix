...
const BestRecipe = () => {
  return (
    <div className="w-full p-5 py-2 h-auto flex items-center justify-between">
      ...
      <div className="flex flex-2 justify-end">
        <div className="flex flex-col justify-center items-center py-2 md:px-3 lg:px-4 xl:px-5">
        ...
        <div className="flex flex-col justify-center items-center py-2 md:px-3 lg:px-4 xl:px-5 border-l-2 border-l-gray-300">
